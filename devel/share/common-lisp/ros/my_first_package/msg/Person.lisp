...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_first_package-msg:<Person> is deprecated: use my_first_package-msg:Person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_first_package-msg:name-val is deprecated.  Use my_first_package-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_first_package-msg:age-val is deprecated.  Use my_first_package-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'gender-val :lambda-list '(m))
(cl:defmethod gender-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_first_package-msg:gender-val is deprecated.  Use my_first_package-msg:gender instead.")
  (gender m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person>)))
  ...
  (cl:format cl:nil "string name~%int32 age~%string gender~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person)))
  "Returns full string definition for message of type 'Person"
  (cl:format cl:nil "string name~%int32 age~%string gender~%~%~%"))
