...
(cl:defclass <GoToActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type new_package-msg:GoToGoal
    :initform (cl:make-instance 'new_package-msg:GoToGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GoToActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoToActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name new_package-msg:<GoToActionGoal> is deprecated: use new_package-msg:GoToActionGoal instead.")))
